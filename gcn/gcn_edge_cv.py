...
for i in range(n_fold):
    ...
    for thetas_combo in thetas_combos:
        ...
        if tuple(thetas_combo) not in err_dict:
            err_dict[tuple(thetas_combo)] = []
        err_dict[tuple(thetas_combo)].append(compute_error(cm))
...
best_theta_combo = min(err_dict, key=err_dict.get)
best_theta_1 = best_theta_combo[0]
best_theta_2 = best_theta_combo[1]

print('Best theta_1:', best_theta_1, 'Best theta_2:', best_theta_2)
